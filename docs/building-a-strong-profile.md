...
## Start With What You Actually Did, Not Your Job Title

Job titles are labels someone else gave you. They rarely describe the real work.
...
## Find the Capabilities Hiding Inside Your Tasks

Most people describe their work as a list of tasks. Tasks are what you did. Capabilities are what those tasks required you to be good at. The scorer matches capabilities to job requirements, not tasks to tasks.
...
**Exercise:** Take your task list for each role and rewrite every item as the capability it required. Ask yourself: "What did I have to be good at to do this well?"

---

## Find Your Patterns (Your Throughline)

If you've held multiple roles, look for what stays the same across all of them. Not the industry, not the title, not the company. The type of work you kept doing regardless of what your job was called.

Some questions to surface this:

- What did people consistently come to you for, at every job?
- What kind of problems did you keep solving, even when it wasn't technically your job?
- When you describe what you liked most about each role, is there a common thread?
- If three former colleagues described you to a stranger, what would they all say?

The answers usually reveal a throughline. Maybe you're always the person who builds structure where there wasn't any. Maybe you're always the one translating between technical and non-technical people. Maybe you're the one who anticipates what's going to go wrong before anyone else sees it.

That throughline belongs in your Summary and in your Strengths. It's the thing that makes your career make sense even if your titles look scattered.

**Exercise:** Write one sentence that captures the pattern across your career. Test it: does it still apply if you change the company name and industry? If yes, it's a real pattern.

---

## Map Your Experience to Your Target Roles

This is where most profiles fail. People describe what they did and hope the scorer figures out why it matters for the job they want. Don't make it guess.

For each target role, ask yourself:

1. What does this role actually require someone to do every day?
...
## Be Honest About Your Gaps (And Know the Difference)

There are three kinds of gaps. They affect scoring differently, and mixing them up weakens your profile.
...
**Exercise:** Go through your gap list and ask for each one: "If a job required this and I had an interview tomorrow, could I credibly demonstrate it?" If no, it's a hard blocker. If "not perfectly but I'd have a decent shot," it's a soft gap. If "yes, I just haven't called it that before," it's not a gap at all, it's a transferability connection.

---

## Collect Your Stories

Capabilities tell the scorer what you can do. Stories show how you actually do it. They're different, and the stories are often more useful.

Think about moments in your career that reveal how you work, not just what you worked on. These don't need to be dramatic or impressive. The best ones are usually small and specific:
...
## A Note on ATS Keywords

Most companies use Applicant Tracking Systems that scan your resume for specific terms before a human ever sees it. This matters for your profile in two ways.

First, when you describe your skills and experience, use the language your target roles actually use. If job postings in your field say "cross-functional stakeholder management," don't write "worked with different teams." Same capability, but one gets past the ATS and the other might not.
...
## Write Your Match Signals From Experience, Not Aspiration

Unique match signals should describe conditions where you've ALREADY done your best work, not conditions you think you'd enjoy.

Weak: "I think I'd thrive in a remote-first culture."
Strong: "I've worked fully remote for five years and my best project outcomes happened during that time."

Weak: "I'm interested in growth-stage companies."
...
**Exercise:** For each match signal, write one sentence of proof. If you can't, it's an aspiration, not a signal. It might still belong in your profile, but label it honestly.

---

## Use the Companion Project to Go Deeper

If you've read this far and you're stuck, or you know your profile isn't deep enough but you can't see what's missing, use the companion project.

Upload what you have (even a resume) into a Claude project with the companion instructions. Say "help me build my profile" or "review my profile and tell me where it's shallow." The companion is specifically built to:

- Ask follow-up questions that surface capabilities you haven't articulated
- Push back when your descriptions are too vague for a scorer to use
- Help you distinguish hard blockers from soft gaps
- Identify transferable skills you're not seeing
- Draw connections between your experience and your target roles

Think of it as a thinking partner for your job search. It's not going to tell you what you want to hear. It's going to help you see what's actually there.
...
A strong profile:
- Describes capabilities, not just tasks
- Makes the connection to target roles explicit, not implied
- Includes specific, verifiable numbers where they exist
- Has hard blockers that are genuinely hard, not just areas of nervousness
- Has match signals grounded in real experience, not aspiration
- Tells a coherent story across roles, even if the titles and industries changed
- Is honest about gaps without apologising for them

A weak profile:
- Reads like a resume pasted into markdown
- Uses vague phrases like "strong communicator" or "detail-oriented"
- Lists tasks instead of capabilities
- Hopes the scorer will figure out why the experience is relevant
- Has no hard blockers (everyone has them) or too many (most things are soft gaps)
- Describes what the candidate wants without showing why they'd be good at it

Your profile is private. Nobody reads it but you and the scorer. There's no reason to be anything other than completely honest.
